...
type CategorySelectProps = {
    ...
    setSelectedCategories: React.Dispatch<
        React.SetStateAction<SelectedCategoryType>
    >;
};
                        ...
                        >
                            <CheckboxInput
                                ...
                                onChange={() => {
                                    setSelectedCategories(
                                        (
                                            prevSelectedCategories: SelectedCategoryType,
                                        ) => ({
                                ...
                                value={
                                    selectedCategories[sluggedCategory] ?? false
                                }
                            />
                            <p className="text-preset-5">
                                {category} <span>({occurences})</span>
                            </p>
                        </label>
                    );
                })}
