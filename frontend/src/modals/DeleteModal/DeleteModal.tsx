...
export default function DeleteModal({ setShowDeleteModal }: { setShowDeleteModal: React.Dispatch<React.SetStateAction<boolean>> }) {
    ...
    return (
        <div className={styles["delete-modal"]} ref={deleteModalRef}>
            ...
            <div className={styles["delete-modal-buttons"]}>
                ...
                <Button text="Delete Card" onClick={() => setShowDeleteModal(false)} variants="shadow" />
            </div>
        </div>
    )
}