...
export default function FlashcardContainer() {
            ...
            <div className={styles["flashcard-container"]}>
                ...
                <div className={styles["flashcard-container-empty"]}>
                    ...
                    <p className="text-preset-4-regular">
                        You don’t have any cards yet. Add your first card in the
                        All Cards tab.
                    </p>
                    <Button
    ...
    if (
        flashcards.length ===
            flashcards.filter((flashcard) => flashcard.knownCount >= 5)
                .length &&
        hideMastered
    ) {
        return (
            <div className={styles["flashcard-container"]}>
                ...
                <div className={styles["flashcard-container-empty"]}>
                    ...
                    <p className="text-preset-4-regular">
                        All your cards are mastered. Turn off “Hide mastered” to
                        see them again.
                    </p>
                </div>
            </div>
