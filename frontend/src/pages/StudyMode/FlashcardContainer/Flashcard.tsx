...
export default function Flashcard ({ flashcard }: FlashcardProps) {
    ...
    return(
        <div className={`${styles["flashcard"]} ${isRevealed ? styles["flashcard-revealed"] : ''}`}>
            {isRevealed 
            ? <img src={"/assets/images/pattern-star-pink.svg"} alt="pattern-star-pink" className={styles['flashcard-star-top']} />
            : <img src={"/assets/images/pattern-star-blue.svg"} alt="pattern-star-blue" className={styles['flashcard-star-top']} />
            }
            <img src={"/assets/images/pattern-star-yellow.svg"} alt="pattern-star-yellow" className={styles['flashcard-star-bottom']} />
            ...
            <div className={styles['flashcard-main']}>
                ...
                >{!isRevealed ? 'Click to reveal answer':'Answer :'}</button>
            </div>
